...
from hydrax.tasks.franka_teleop_push import FrankaTeleopPush

"""
Run an interactive simulation of the franka teleoperation push task.

Double click on the green target, then drag it around with [ctrl + right-click].
The Franka arm will follow your commands while ensuring the box stays on the table.
"""

# Define the task (cost and dynamics)
task = FrankaTeleopPush()

# Parse command-line arguments
parser = argparse.ArgumentParser(
    description="Run an interactive simulation of the franka teleoperation push task."
)
