...
class FrankaTeleopPush(Task):
    """Franka teleoperation with a pushable box on a table."""
    ...
    def __init__(
        ...
        mj_model = mujoco.MjModel.from_xml_path(
            ROOT + "/models/franka_emika_panda/mjx_scene_teleop_push.xml"
        )
    ...
    def constraint_cost(self, state: mjx.Data, control: jax.Array) -> jax.Array:
        ...
        return box_constraint + gripper_constraint
